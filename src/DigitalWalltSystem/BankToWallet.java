...
public class BankToWallet extends PaymentMethod{

    public BankToWallet(Account account1, Account account2, double amount){
    ...
    public void processPayment() {
        if(account1.debit(amount)){
            ...
            System.out.println("Amount of rupees " + amount + " has been transferred from Bank of" +
                    account1.user.getName() + " to Wallet of " + account2.user.getName());
        }
        else {
